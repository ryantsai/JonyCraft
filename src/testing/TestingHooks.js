...
export class TestingHooks {
  ...
  _createSnapshot() {
    ...
    return JSON.stringify({
      ...
      defense: {
        enabled: this.state.defense.enabled,
        remoteAuthoritative: this.state.defense.remoteAuthoritative,
        status: this.state.defense.status,
        wave: this.state.defense.wave,
        timeLeft: Number(this.state.defense.timeLeft.toFixed(1)),
        towerHp: Number(this.state.defense.towerHp.toFixed(1)),
        towerMaxHp: this.state.defense.towerMaxHp,
      ...
      multiplayer: {
        ...
        serverHost: this.state.multiplayer.serverHost,
        serverPort: this.state.multiplayer.serverPort,
        ...
        playerStats: this.state.multiplayer.playerStats.map((player) => ({
          name: player.name,
          kills: player.kills,
          gold: player.gold,
